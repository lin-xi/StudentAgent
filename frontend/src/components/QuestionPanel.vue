    ...
    <div class="question-panel">
        ...
        <div class="options-list">
            ...
            >
                ...
                <span
                    v-if="answered && key === question.answer"
                    class="option-mark"
                    >✓</span
                >
                <span
        ...
        <!-- 反馈 -->
        <div
            v-if="answered && evaluation"
            class="feedback"
            :class="{ correct: evaluation.passed, wrong: !evaluation.passed }"
        >
        ...
        <div v-if="showHint" class="hint-box">
            <strong>💡 小提示：</strong>
            这道题已经连续答错
            {{ consecutiveFails }} 次了，建议回顾一下相关知识点，<br />
